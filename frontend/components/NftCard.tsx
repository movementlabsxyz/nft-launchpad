const NftCard = () => {
  return (
    <div role="status" className="space-y-8 animate-pulse md:space-y-0 md:flex flex-col md:items-center">
      ...
      <div className="w-full flex-col justify-start">
          <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-1 mt-2"></div>
